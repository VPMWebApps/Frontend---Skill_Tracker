      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <div className="bg-gray-200 rounded-lg p-4 border ">
              ...
              <div className="space-y-3">
                <button className="block w-full h-[10vh] bg-black text-white px-4 py-3 rounded-lg text-left hover:bg-gray-800 transition">Frontend</button>
                <button className="block w-full h-[10vh] bg-black text-white px-4 py-3 rounded-lg text-left hover:bg-gray-800 transition">Backend</button>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="bg-gray-200 h-48 rounded-lg border p-5 text-3xl font-medium">My Progress</div>
          </div>
        </div>
