  ...
  return (
    <div className="p-10  min-h-screen">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-5 pl-[6rem] pr-[6rem]">
        ...
        <div className="md:col-span-2 bg-black text-white w-[42vw]  h-[40vh] rounded-3xl p-6 cursor-pointer">
          <h1 className="text-3xl font-bold  ">Welcome, User</h1>
        </div>

        <div className="md:col-span-2 bg-white border-1 w-[42vw] to-gray-200 rounded-3xl p-6 cursor-pointer">
